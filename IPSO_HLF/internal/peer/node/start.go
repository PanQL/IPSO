...
import (
	...
	discprotos "github.com/PanQL/fabric-protos-go/discovery"
...
func serve(args []string) error {
	...
	custodianLauncher := custodianLauncherAdapter{
		launcher:      chaincodeLauncher,
		streamHandler: chaincodeSupport,// 这里的streamHandler被赋值为chaincodeSupport，这样就可以处理外部链码的流式调用
	}
