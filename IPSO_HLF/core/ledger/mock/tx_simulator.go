...
type TxSimulator struct {
	CommitStub        func(string, *ledger.TxSimulationResults)
	commitMutex       sync.RWMutex
	commitArgsForCall []struct {
		arg1 string
		arg2 *ledger.TxSimulationResults
	}
...
func (fake *TxSimulator) Commit(arg1 string, arg2 *ledger.TxSimulationResults) {
...
func (fake *TxSimulator) CommitCalls(stub func(string, *ledger.TxSimulationResults)) {
	fake.commitMutex.Lock()
	defer fake.commitMutex.Unlock()
	fake.CommitStub = stub
}

func (fake *TxSimulator) CommitArgsForCall(i int) (string, *ledger.TxSimulationResults) {
	fake.commitMutex.RLock()
	defer fake.commitMutex.RUnlock()
...
func (fake *TxSimulator) TracePath(ns string, hotPathCond *peer.HotPathCond) {
	// fake.rwsetBuilder.TracePath(txid)
}
