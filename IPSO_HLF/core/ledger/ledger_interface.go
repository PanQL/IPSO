...
type TxSimulator interface {
	...
	Commit(txid string, rwdSetProto *TxSimulationResults)
	Rollback(txid string)
	TracePath(ns string, hotPathCond *peer.HotPathCond)
	// optimistic code end
}
...
// `github.com/PanQL/fabric-protos-go/ledger/rwset/kvrwset.KVWrite`
