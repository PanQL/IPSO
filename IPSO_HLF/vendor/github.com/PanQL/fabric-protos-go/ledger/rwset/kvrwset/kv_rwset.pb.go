...
// KVRWDSet encapsulates the read-write set for a chaincode that operates upon a KV or Document data model
// This structure is used for both the public data and the private data
type KVRWDSet struct {
	...
	Condition            *peer.HotPathCond  `protobuf:"bytes,6,opt,name=condition,proto3" json:"condition,omitempty"`
	XXX_NoUnkeyedLiteral struct{}           `json:"-"`
	XXX_unrecognized     []byte             `json:"-"`
	XXX_sizecache        int32              `json:"-"`
}

func (m *KVRWDSet) Reset()         { *m = KVRWDSet{} }
func (m *KVRWDSet) String() string { return proto.CompactTextString(m) }
func (*KVRWDSet) ProtoMessage()    {}
func (*KVRWDSet) Descriptor() ([]byte, []int) {
	return fileDescriptor_ee5d686eab23a142, []int{1}
}

func (m *KVRWDSet) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_KVRWDSet.Unmarshal(m, b)
}
func (m *KVRWDSet) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_KVRWDSet.Marshal(b, m, deterministic)
}
func (m *KVRWDSet) XXX_Merge(src proto.Message) {
	xxx_messageInfo_KVRWDSet.Merge(m, src)
}
func (m *KVRWDSet) XXX_Size() int {
	return xxx_messageInfo_KVRWDSet.Size(m)
}
func (m *KVRWDSet) XXX_DiscardUnknown() {
	xxx_messageInfo_KVRWDSet.DiscardUnknown(m)
}

var xxx_messageInfo_KVRWDSet proto.InternalMessageInfo

func (m *KVRWDSet) GetReads() []*KVRead {
	if m != nil {
		return m.Reads
	}
	return nil
...
func (m *KVRWDSet) GetRangeQueriesInfo() []*RangeQueryInfo {
	if m != nil {
		return m.RangeQueriesInfo
	}
	return nil
...
func (m *KVRWDSet) GetWrites() []*KVWrite {
	if m != nil {
		return m.Writes
	}
	return nil
...
func (m *KVRWDSet) GetMetadataWrites() []*KVMetadataWrite {
	if m != nil {
		return m.MetadataWrites
	}
	return nil
...
func (m *KVRWDSet) GetDeltas() []*KVDelta {
	if m != nil {
		return m.Deltas
	}
	return nil
...
func (m *KVRWDSet) GetCondition() *peer.HotPathCond {
	if m != nil {
		return m.Condition
	}
	return nil
...
func (m *KVDelta) Reset()         { *m = KVDelta{} }
func (m *KVDelta) String() string { return proto.CompactTextString(m) }
func (*KVDelta) ProtoMessage()    {}
func (*KVDelta) Descriptor() ([]byte, []int) {
	return fileDescriptor_ee5d686eab23a142, []int{2}
}

func (m *KVDelta) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_KVDelta.Unmarshal(m, b)
}
func (m *KVDelta) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_KVDelta.Marshal(b, m, deterministic)
}
func (m *KVDelta) XXX_Merge(src proto.Message) {
	xxx_messageInfo_KVDelta.Merge(m, src)
}
func (m *KVDelta) XXX_Size() int {
	return xxx_messageInfo_KVDelta.Size(m)
}
func (m *KVDelta) XXX_DiscardUnknown() {
	xxx_messageInfo_KVDelta.DiscardUnknown(m)
}

var xxx_messageInfo_KVDelta proto.InternalMessageInfo

func (m *KVDelta) GetKey() string {
	if m != nil {
		return m.Key
	}
	return ""
...
func (*QueryReadsMerkleSummary) Descriptor() ([]byte, []int) {
	return fileDescriptor_ee5d686eab23a142, []int{14}
}
...
func init() {
	...
	proto.RegisterType((*KVRWDSet)(nil), "kvrwset.KVRWDSet")
	proto.RegisterType((*KVDelta)(nil), "kvrwset.KVDelta")
...
var fileDescriptor_ee5d686eab23a142 = []byte{
	...
	,
}
