...
type HotPathCondType int32

const (
	HotPathCondType_CHECKING_LARGER       HotPathCondType = 0
	HotPathCondType_CHECKING_LARGER_EQUAL HotPathCondType = 1
	HotPathCondType_SAVING_LARGER         HotPathCondType = 2
	HotPathCondType_SAVING_LARGER_EQUAL   HotPathCondType = 3
)

var HotPathCondType_name = map[int32]string{
	0: "CHECKING_LARGER",
	1: "CHECKING_LARGER_EQUAL",
	2: "SAVING_LARGER",
	3: "SAVING_LARGER_EQUAL",
}

var HotPathCondType_value = map[string]int32{
	"CHECKING_LARGER":       0,
	"CHECKING_LARGER_EQUAL": 1,
	"SAVING_LARGER":         2,
	"SAVING_LARGER_EQUAL":   3,
}

func (x HotPathCondType) String() string {
	return proto.EnumName(HotPathCondType_name, int32(x))
}

func (HotPathCondType) EnumDescriptor() ([]byte, []int) {
...
const (
	...
	ChaincodeMessage_HINT_HOT_PATH_POINT   ChaincodeMessage_Type = 23
)
...
type HotPathCond struct {
	Key                  string          `protobuf:"bytes,1,opt,name=key,proto3" json:"key,omitempty"`
	CondType             HotPathCondType `protobuf:"varint,2,opt,name=cond_type,json=condType,proto3,enum=protos.HotPathCondType" json:"cond_type,omitempty"`
...
func (m *HotPathCond) Reset()         { *m = HotPathCond{} }
func (m *HotPathCond) String() string { return proto.CompactTextString(m) }
func (*HotPathCond) ProtoMessage()    {}
func (*HotPathCond) Descriptor() ([]byte, []int) {
	return fileDescriptor_e5819fec16c96da2, []int{1}
}

func (m *HotPathCond) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_HotPathCond.Unmarshal(m, b)
}
func (m *HotPathCond) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_HotPathCond.Marshal(b, m, deterministic)
}
func (m *HotPathCond) XXX_Merge(src proto.Message) {
	xxx_messageInfo_HotPathCond.Merge(m, src)
}
func (m *HotPathCond) XXX_Size() int {
	return xxx_messageInfo_HotPathCond.Size(m)
}
func (m *HotPathCond) XXX_DiscardUnknown() {
	xxx_messageInfo_HotPathCond.DiscardUnknown(m)
}

var xxx_messageInfo_HotPathCond proto.InternalMessageInfo

func (m *HotPathCond) GetKey() string {
	if m != nil {
		return m.Key
	}
	return ""
...
func (m *HotPathCond) GetCondType() HotPathCondType {
	if m != nil {
		return m.CondType
	}
	return HotPathCondType_CHECKING_LARGER
}

func (m *HotPathCond) GetAmount() int64 {
	if m != nil {
		return m.Amount
	}
	return 0
...
// which needs to be written to the transaction's write set. If the collection
// is specified, the key and value would be written to the transaction's private
// write set.
...
// GetStateByRange is the payload of a ChaincodeMessage. It contains a start key
// and a end key required to execute range query. If the collection is
// specified, the range query needs to be executed on the private data. The
// metadata hold the byte representation of QueryMetadata.
...
// QueryResultBytes hold the byte representation of a record returned by the
// peer.
...
// the peer in has_more field, transaction id in id field, and a
// QueryResponseMetadata in metadata field.
...
func init() {
	proto.RegisterEnum("protos.HotPathCondType", HotPathCondType_name, HotPathCondType_value)
	...
	proto.RegisterType((*HotPathCond)(nil), "protos.HotPathCond")
...
var fileDescriptor_e5819fec16c96da2 = []byte{
	...
	,
}
