...
import (
	...
	"github.com/PanQL/fabric-protos-go/ledger/queryresult"
...
// HintHotPathCond documentation can be found in interfaces.go
func (s *ChaincodeStub) HintHotPathCond(key string, cond pb.HotPathCondType, amount int) error {
	return s.handler.handleHintHotPathCond(s.ChannelID, s.TxID, key, cond, amount)
}
