...
type ChaincodeStubInterface interface {
	...
	// https://godoc.org/github.com/PanQL/fabric-protos-go/common#ChannelHeader
	// for further details.
	GetTxID() string
	...
	// HintHotPathCond delivers a hint to the peer that a branch is executed
	HintHotPathCond(key string, cond pb.HotPathCondType, amount int) error
}
